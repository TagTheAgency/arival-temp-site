...
?>
		...
		<div class="container-fluid black py-5 text-white">
		...
		<div class="container-fluid black text-white pb-5 pb-sm-0 fade-in">
		...
		<div class="container-fluid black text-white pb-5 pb-sm-0 fade-in">
			<div class="row text-right align-items-center justify-content-center py-5 section-img hero-banner-full">
				<div class="col-11 text-center text-sm-center col-sm-7 col-md-4">
				...
				<div class="col-8 col-sm-4 mt-5 mt-sm-0">
					<div class="img-container">
		...
		<div class="container-fluid black text-white text-center pb-sm-5 fade-in">
			<div class="row justify-content-center align-items-center py-2 py-sm-5">
				<div class="col-11 col-md-6 col-lg-5">
					<h2 class="underline underline-gradient ls-8 text-white">GET IN TOUCH</h2>
				</div>
				<div class="col-11 col-md-6 col-lg-5">
